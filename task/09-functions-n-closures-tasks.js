...
function getPolynom() {
    ...
    let answer="y=";
    let power=n-1;
    for(let i=0;i<n-1 && power>0;i++)
    {
        answer+=arguments[i]+`x^${power--}+`;
        
    }
    answer+=arguments[n-1];
    return answer;
}
 ...
 */
 function partialUsingArguments(fn) {
    let argumentsOfFunction1 = Object.values(arguments).slice(1);
    return function () {
        let argumentsOfFunction2 = Object.values(arguments);
        return argumentsOfFunction1.concat(argumentsOfFunction2).join('');
    }
}
